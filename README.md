...
[![functions](https://img.shields.io/badge/functions_matched-1164_of_1461_(79.67%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-424464_of_944356_(44.95%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1399_adopted-blue)](#progress)

```
functions     1164 / 1461    79.67%   matched to C, byte-identical
.text bytes 267956 / 475092  56.40%   matched C in the resident segment
...
whole resolved 424464 / 944356  44.95%   resident C + verified asm + overlay C
