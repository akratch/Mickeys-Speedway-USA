...
[![functions](https://img.shields.io/badge/functions_matched-1170_of_1461_(80.08%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-433388_of_944356_(45.89%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1407_adopted-blue)](#progress)

```
functions     1170 / 1461    80.08%   matched to C, byte-identical
.text bytes 276880 / 475092  58.28%   matched C in the resident segment
...
whole resolved 433388 / 944356  45.89%   resident C + verified asm + overlay C
