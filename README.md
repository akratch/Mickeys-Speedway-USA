...
[![functions](https://img.shields.io/badge/functions_matched-1047_of_1460_(71.71%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-379756_of_944348_(40.21%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1301_adopted-blue)](#progress)

```
functions     1047 / 1460    71.71%   matched to C, byte-identical
.text bytes 239228 / 475084  50.35%   matched C in the resident segment
...
whole resolved 379756 / 944348  40.21%   resident C + verified asm + overlay C
...
```
decompiled              362572 / 944348  (38.39%)
handwritten asm          17184 / 944348  ( 1.82%)
GLOBAL_ASM remaining    264072 / 944348  (27.96%)
