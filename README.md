...
[![functions](https://img.shields.io/badge/functions_matched-1141_of_1461_(78.10%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-402144_of_944416_(42.58%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1386_adopted-blue)](#progress)

```
functions     1141 / 1461    78.10%   matched to C, byte-identical
.text bytes 254432 / 475152  53.55%   matched C in the resident segment
verified asm  17184 / 475152   3.62%   original hand-written assembly (84 functions)
overlay C   130528 / 469264  27.82%   matched C keyed by overlay and offset
whole resolved 402144 / 944416  42.58%   resident C + verified asm + overlay C
...
```
decompiled              384960 / 944416  (40.76%)
handwritten asm          17184 / 944416  ( 1.82%)
GLOBAL_ASM remaining    215584 / 944416  (22.83%)
NON_MATCHING            326688 / 944416  (34.59%)
...
| game code, TU identified | 1153 | 870 | 73 | 210 | `███████████████▓░░░░` 81.8% |
