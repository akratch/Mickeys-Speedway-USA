...
[![functions](https://img.shields.io/badge/functions_matched-1057_of_1460_(72.40%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-384916_of_944356_(40.76%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1324_adopted-blue)](#progress)

```
functions     1057 / 1460    72.40%   matched to C, byte-identical
.text bytes 243060 / 475092  51.16%   matched C in the resident segment
...
whole resolved 384916 / 944356  40.76%   resident C + verified asm + overlay C
...
```
decompiled              367732 / 944356  (38.94%)
handwritten asm          17184 / 944356  ( 1.82%)
GLOBAL_ASM remaining    260248 / 944356  (27.56%)
...
| game code, TU identified | 1068 | 787 | 74 | 207 | `███████████████▓░░░░` 80.6% |
