...
[![functions](https://img.shields.io/badge/functions_matched-1137_of_1461_(77.82%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-395696_of_944416_(41.90%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1386_adopted-blue)](#progress)

```
functions     1137 / 1461    77.82%   matched to C, byte-identical
.text bytes 253348 / 475152  53.32%   matched C in the resident segment
...
whole resolved 395696 / 944416  41.90%   resident C + verified asm + overlay C
...
```
decompiled              378512 / 944416  (40.08%)
handwritten asm          17184 / 944416  ( 1.82%)
GLOBAL_ASM remaining    216668 / 944416  (22.94%)
