...
[![functions](https://img.shields.io/badge/functions_matched-1066_of_1460_(73.01%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-385772_of_944348_(40.85%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1348_adopted-blue)](#progress)

```
functions     1066 / 1460    73.01%   matched to C, byte-identical
.text bytes 243916 / 475084  51.34%   matched C in the resident segment
...
whole resolved 385772 / 944348  40.85%   resident C + verified asm + overlay C
...
```
decompiled              368588 / 944348  (39.03%)
handwritten asm          17184 / 944348  ( 1.82%)
GLOBAL_ASM remaining    259384 / 944348  (27.47%)
...
| game code, TU identified | 1027 | 796 | 73 | 158 | `████████████████▓░░░` 84.6% |
| game code, not yet split | 134 | 0 | 3 | 131 | `▓░░░░░░░░░░░░░░░░░░░` 2.2% |
...
**Source organization**: 595 fully-C translation units and 243 C scaffolds that still include assembly: 150 under `src/libultra/`; 52 under `src/main/`, including `matrix.c` (matrix/vector maths) and `runlink.c` (the runtime overlay linker core); 636 across 106 `src/overlays/oNNN/` directories (largest: `o101` 71, `o014` 28, `o011` 26, `o057` 22, `o084` 22).
