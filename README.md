...
[![functions](https://img.shields.io/badge/functions_matched-1156_of_1461_(79.12%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-419456_of_944356_(44.42%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1393_adopted-blue)](#progress)

```
functions     1156 / 1461    79.12%   matched to C, byte-identical
.text bytes 263648 / 475092  55.49%   matched C in the resident segment
verified asm  17184 / 475092   3.62%   original hand-written assembly (84 functions)
overlay C   138624 / 469264  29.54%   matched C keyed by overlay and offset
whole resolved 419456 / 944356  44.42%   resident C + verified asm + overlay C
named         1257 / 1461    86.04%   functions carrying an adopted name
symbols       1393                    adopted in symbol_addrs.us.txt
```
...
| game code, TU identified | 1153 | 885 | 72 | 196 | `███████████████▓▓░░░` 83.0% |
| game code, not yet split | 7 | 0 | 0 | 7 | `░░░░░░░░░░░░░░░░░░░░` 0.0% |
| **total** | 1461 | 1156 | 101 | 204 | `████████████████▓░░░` 86.0% |
