...
[![functions](https://img.shields.io/badge/functions_matched-1101_of_1460_(75.41%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-388928_of_944376_(41.18%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1363_adopted-blue)](#progress)

```
functions     1101 / 1460    75.41%   matched to C, byte-identical
.text bytes 247072 / 475112  52.00%   matched C in the resident segment
verified asm  17184 / 475112   3.62%   original hand-written assembly (84 functions)
overlay C   124672 / 469264  26.57%   matched C keyed by overlay and offset
whole resolved 388928 / 944376  41.18%   resident C + verified asm + overlay C
named         1204 / 1460    82.47%   functions carrying an adopted name
symbols       1363                    adopted in symbol_addrs.us.txt
```
...
```
decompiled              371744 / 944376  (39.36%)
handwritten asm          17184 / 944376  ( 1.82%)
GLOBAL_ASM remaining    247184 / 944376  (26.17%)
NON_MATCHING            308264 / 944376  (32.64%)
NON_EQUIVALENT               0 / 944376  ( 0.00%)
```

| Area | Functions | Matched to C | Named, still asm | Unnamed | Identified |
| :--- | ---: | ---: | ---: | ---: | :--- |
| libultra corridor | 299 | 270 | 29 | 0 | `██████████████████▓▓` 100.0% |
| game code, TU identified | 1137 | 831 | 73 | 233 | `███████████████▓░░░░` 79.5% |
| game code, not yet split | 24 | 0 | 1 | 23 | `▓░░░░░░░░░░░░░░░░░░░` 4.2% |
| **total** | 1460 | 1101 | 103 | 256 | `███████████████▓░░░░` 82.5% |
...
**Source organization**: 597 fully-C translation units and 254 C scaffolds that still include assembly: 150 under `src/libultra/`; 60 under `src/main/`, including `matrix.c` (matrix/vector maths) and `runlink.c` (the runtime overlay linker core); 641 across 106 `src/overlays/oNNN/` directories (largest: `o101` 71, `o014` 28, `o011` 26, `o057` 22, `o084` 22).
