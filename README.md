...
[![functions](https://img.shields.io/badge/functions_matched-1158_of_1461_(79.26%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-419868_of_944356_(44.46%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1394_adopted-blue)](#progress)

```
functions     1158 / 1461    79.26%   matched to C, byte-identical
.text bytes 264220 / 475092  55.61%   matched C in the resident segment
...
whole resolved 419868 / 944356  44.46%   resident C + verified asm + overlay C
named         1259 / 1461    86.17%   functions carrying an adopted name
symbols       1394                    adopted in symbol_addrs.us.txt
```
...
| game code, TU identified | 1153 | 887 | 72 | 194 | `███████████████▓▓░░░` 83.2% |
| game code, not yet split | 7 | 0 | 0 | 7 | `░░░░░░░░░░░░░░░░░░░░` 0.0% |
| **total** | 1461 | 1158 | 101 | 202 | `████████████████▓░░░` 86.2% |
