...
[![functions](https://img.shields.io/badge/functions_matched-1058_of_1460_(72.47%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-384996_of_944348_(40.77%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1325_adopted-blue)](#progress)

```
functions     1058 / 1460    72.47%   matched to C, byte-identical
.text bytes 243140 / 475084  51.18%   matched C in the resident segment
...
whole resolved 384996 / 944348  40.77%   resident C + verified asm + overlay C
named         1163 / 1460    79.66%   functions carrying an adopted name
symbols       1325                    adopted in symbol_addrs.us.txt
```
...
```
decompiled              367812 / 944348  (38.95%)
handwritten asm          17184 / 944348  ( 1.82%)
GLOBAL_ASM remaining    260160 / 944348  (27.55%)
...
| game code, TU identified | 1007 | 788 | 73 | 146 | `████████████████▓░░░` 85.5% |
| game code, not yet split | 154 | 0 | 3 | 151 | `▓░░░░░░░░░░░░░░░░░░░` 1.9% |
| **total** | 1460 | 1058 | 105 | 297 | `██████████████▓▓░░░░` 79.7% |
...
**Source organization**: 595 fully-C translation units and 241 C scaffolds that still include assembly: 150 under `src/libultra/`; 50 under `src/main/`, including `matrix.c` (matrix/vector maths) and `runlink.c` (the runtime overlay linker core); 636 across 106 `src/overlays/oNNN/` directories (largest: `o101` 71, `o014` 28, `o011` 26, `o057` 22, `o084` 22).
