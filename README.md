...
GLOBAL_ASM remaining    210156 / 944416  (22.25%)
NON_MATCHING            327212 / 944416  (34.65%)
...
**Source organization**: 612 fully-C translation units and 248 C scaffolds that still include assembly: 152 under `src/libultra/`; 63 under `src/main/`, including `matrix.c` (matrix/vector maths) and `runlink.c` (the runtime overlay linker core); 645 across 106 `src/overlays/oNNN/` directories (largest: `o101` 71, `o014` 28, `o011` 26, `o057` 22, `o084` 22).
