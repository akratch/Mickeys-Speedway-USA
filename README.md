...
[![functions](https://img.shields.io/badge/functions_matched-1049_of_1460_(71.85%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-380748_of_944348_(40.32%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1303_adopted-blue)](#progress)

```
functions     1049 / 1460    71.85%   matched to C, byte-identical
.text bytes 240220 / 475084  50.56%   matched C in the resident segment
...
whole resolved 380748 / 944348  40.32%   resident C + verified asm + overlay C
...
```
decompiled              363564 / 944348  (38.50%)
handwritten asm          17184 / 944348  ( 1.82%)
GLOBAL_ASM remaining    263080 / 944348  (27.86%)
