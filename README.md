...
[![functions](https://img.shields.io/badge/functions_matched-1045_of_1460_(71.58%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-380844_of_944348_(40.33%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1300_adopted-blue)](#progress)

```
functions     1045 / 1460    71.58%   matched to C, byte-identical
.text bytes 238388 / 475084  50.18%   matched C in the resident segment
verified asm  17184 / 475084   3.62%   original hand-written assembly (84 functions)
overlay C   125272 / 469264  26.70%   matched C keyed by overlay and offset
whole resolved 380844 / 944348  40.33%   resident C + verified asm + overlay C
...
```
decompiled              363660 / 944348  (38.51%)
handwritten asm          17184 / 944348  ( 1.82%)
GLOBAL_ASM remaining    264912 / 944348  (28.05%)
NON_MATCHING            298592 / 944348  (31.62%)
