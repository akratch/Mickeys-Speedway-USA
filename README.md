...
[![functions](https://img.shields.io/badge/functions_matched-1069_of_1460_(73.22%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-386188_of_944360_(40.89%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1351_adopted-blue)](#progress)

```
functions     1069 / 1460    73.22%   matched to C, byte-identical
.text bytes 244332 / 475096  51.43%   matched C in the resident segment
...
whole resolved 386188 / 944360  40.89%   resident C + verified asm + overlay C
named         1174 / 1460    80.41%   functions carrying an adopted name
symbols       1351                    adopted in symbol_addrs.us.txt
```
...
```
decompiled              369004 / 944360  (39.07%)
handwritten asm          17184 / 944360  ( 1.82%)
GLOBAL_ASM remaining    258980 / 944360  (27.42%)
...
| game code, TU identified | 1051 | 799 | 73 | 179 | `███████████████▓▓░░░` 83.0% |
| game code, not yet split | 110 | 0 | 3 | 107 | `▓░░░░░░░░░░░░░░░░░░░` 2.7% |
| **total** | 1460 | 1069 | 105 | 286 | `███████████████▓░░░░` 80.4% |
