...
[![functions](https://img.shields.io/badge/functions_matched-1048_of_1460_(71.78%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-380532_of_944348_(40.30%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1302_adopted-blue)](#progress)

```
functions     1048 / 1460    71.78%   matched to C, byte-identical
.text bytes 240004 / 475084  50.52%   matched C in the resident segment
...
whole resolved 380532 / 944348  40.30%   resident C + verified asm + overlay C
...
```
decompiled              363348 / 944348  (38.48%)
handwritten asm          17184 / 944348  ( 1.82%)
GLOBAL_ASM remaining    263296 / 944348  (27.88%)
