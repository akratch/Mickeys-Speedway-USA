...
[![functions](https://img.shields.io/badge/functions_matched-1153_of_1461_(78.92%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-413736_of_944356_(43.81%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1389_adopted-blue)](#progress)

```
functions     1153 / 1461    78.92%   matched to C, byte-identical
.text bytes 260616 / 475092  54.86%   matched C in the resident segment
...
whole resolved 413736 / 944356  43.81%   resident C + verified asm + overlay C
named         1254 / 1461    85.83%   functions carrying an adopted name
symbols       1389                    adopted in symbol_addrs.us.txt
```
...
| game code, TU identified | 1153 | 882 | 72 | 199 | `███████████████▓▓░░░` 82.7% |
| game code, not yet split | 7 | 0 | 0 | 7 | `░░░░░░░░░░░░░░░░░░░░` 0.0% |
| **total** | 1461 | 1153 | 101 | 207 | `████████████████▓░░░` 85.8% |
