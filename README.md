...
[![functions](https://img.shields.io/badge/functions_matched-1070_of_1460_(73.29%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-386500_of_944360_(40.93%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1352_adopted-blue)](#progress)

```
functions     1070 / 1460    73.29%   matched to C, byte-identical
.text bytes 244644 / 475096  51.49%   matched C in the resident segment
...
whole resolved 386500 / 944360  40.93%   resident C + verified asm + overlay C
named         1175 / 1460    80.48%   functions carrying an adopted name
symbols       1352                    adopted in symbol_addrs.us.txt
```
...
```
decompiled              369316 / 944360  (39.11%)
handwritten asm          17184 / 944360  ( 1.82%)
GLOBAL_ASM remaining    258668 / 944360  (27.39%)
...
| game code, TU identified | 1051 | 800 | 73 | 178 | `███████████████▓▓░░░` 83.1% |
| game code, not yet split | 110 | 0 | 3 | 107 | `▓░░░░░░░░░░░░░░░░░░░` 2.7% |
| **total** | 1460 | 1070 | 105 | 285 | `███████████████▓░░░░` 80.5% |
