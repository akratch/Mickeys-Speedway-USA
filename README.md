...
[![functions](https://img.shields.io/badge/functions_matched-1053_of_1460_(72.12%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-382316_of_944348_(40.48%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1308_adopted-blue)](#progress)

```
functions     1053 / 1460    72.12%   matched to C, byte-identical
.text bytes 241788 / 475084  50.89%   matched C in the resident segment
...
whole resolved 382316 / 944348  40.48%   resident C + verified asm + overlay C
named         1158 / 1460    79.32%   functions carrying an adopted name
symbols       1308                    adopted in symbol_addrs.us.txt
```
...
```
decompiled              365132 / 944348  (38.66%)
handwritten asm          17184 / 944348  ( 1.82%)
GLOBAL_ASM remaining    261512 / 944348  (27.69%)
