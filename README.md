...
[![functions](https://img.shields.io/badge/functions_matched-1055_of_1460_(72.26%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-382852_of_944348_(40.54%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1310_adopted-blue)](#progress)

```
functions     1055 / 1460    72.26%   matched to C, byte-identical
.text bytes 242324 / 475084  51.01%   matched C in the resident segment
...
whole resolved 382852 / 944348  40.54%   resident C + verified asm + overlay C
...
```
decompiled              365668 / 944348  (38.72%)
handwritten asm          17184 / 944348  ( 1.82%)
GLOBAL_ASM remaining    260976 / 944348  (27.64%)
