...
[![functions](https://img.shields.io/badge/functions_matched-1001_of_1463_(68.42%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-348616_of_947416_(36.80%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1272_adopted-blue)](#progress)

```
functions     1001 / 1463    68.42%   matched to C, byte-identical
.text bytes 221856 / 478152  46.40%   matched C in the resident segment
verified asm  17184 / 478152   3.59%   original hand-written assembly (84 functions)
overlay C   109576 / 469264  23.35%   matched C keyed by overlay and offset
whole resolved 348616 / 947416  36.80%   resident C + verified asm + overlay C
...
```
decompiled              331432 / 947416  (34.98%)
handwritten asm          17184 / 947416  ( 1.81%)
GLOBAL_ASM remaining    284512 / 947416  (30.03%)
NON_MATCHING            314288 / 947416  (33.17%)
NON_EQUIVALENT               0 / 947416  ( 0.00%)
```

| Area | Functions | Matched to C | Named, still asm | Unnamed | Identified |
| :--- | ---: | ---: | ---: | ---: | :--- |
| libultra corridor | 289 | 252 | 34 | 3 | `█████████████████▓▓▓` 99.0% |
| game code, TU identified | 996 | 749 | 84 | 163 | `███████████████▓▓░░░` 83.6% |
| game code, not yet split | 178 | 0 | 8 | 170 | `▓░░░░░░░░░░░░░░░░░░░` 4.5% |
