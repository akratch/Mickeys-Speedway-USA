...
[![functions](https://img.shields.io/badge/functions_matched-1066_of_1460_(73.01%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-385772_of_944356_(40.85%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1348_adopted-blue)](#progress)

```
functions     1066 / 1460    73.01%   matched to C, byte-identical
.text bytes 243916 / 475092  51.34%   matched C in the resident segment
...
whole resolved 385772 / 944356  40.85%   resident C + verified asm + overlay C
...
```
decompiled              368588 / 944356  (39.03%)
handwritten asm          17184 / 944356  ( 1.82%)
GLOBAL_ASM remaining    259392 / 944356  (27.47%)
...
| game code, TU identified | 1033 | 796 | 73 | 164 | `███████████████▓▓░░░` 84.1% |
| game code, not yet split | 128 | 0 | 3 | 125 | `▓░░░░░░░░░░░░░░░░░░░` 2.3% |
...
**Source organization**: 595 fully-C translation units and 244 C scaffolds that still include assembly: 150 under `src/libultra/`; 53 under `src/main/`, including `matrix.c` (matrix/vector maths) and `runlink.c` (the runtime overlay linker core); 636 across 106 `src/overlays/oNNN/` directories (largest: `o101` 71, `o014` 28, `o011` 26, `o057` 22, `o084` 22).
