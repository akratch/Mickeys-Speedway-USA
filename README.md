...
[![functions](https://img.shields.io/badge/functions_matched-1201_of_1461_(82.20%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-473904_of_944344_(50.18%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1420_adopted-blue)](#progress)

```
functions     1201 / 1461    82.20%   matched to C, byte-identical
.text bytes 293080 / 475080  61.69%   matched C in the resident segment
verified asm  17184 / 475080   3.62%   original hand-written assembly (84 functions)
overlay C   163640 / 469264  34.87%   matched C keyed by overlay and offset
whole resolved 473904 / 944344  50.18%   resident C + verified asm + overlay C
named         1298 / 1461    88.84%   functions carrying an adopted name
...
| game code, TU identified | 1153 | 930 | 68 | 155 | `████████████████▓░░░` 86.6% |
| game code, not yet split | 7 | 0 | 0 | 7 | `░░░░░░░░░░░░░░░░░░░░` 0.0% |
| **total** | 1461 | 1201 | 97 | 163 | `████████████████▓▓░░` 88.8% |
