...
[![functions](https://img.shields.io/badge/functions_matched-1156_of_1461_(79.12%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-417868_of_944356_(44.25%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1392_adopted-blue)](#progress)
...
overlay C   137036 / 469264  29.20%   matched C keyed by overlay and offset
whole resolved 417868 / 944356  44.25%   resident C + verified asm + overlay C
named         1257 / 1461    86.04%   functions carrying an adopted name
symbols       1392                    adopted in symbol_addrs.us.txt
```
