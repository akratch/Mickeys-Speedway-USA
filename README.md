...
[![functions](https://img.shields.io/badge/functions_matched-1067_of_1461_(73.03%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-386760_of_944352_(40.96%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1333_adopted-blue)](#progress)

```
functions     1067 / 1461    73.03%   matched to C, byte-identical
.text bytes 244904 / 475088  51.55%   matched C in the resident segment
...
whole resolved 386760 / 944352  40.96%   resident C + verified asm + overlay C
...
```
decompiled              369576 / 944352  (39.14%)
handwritten asm          17184 / 944352  ( 1.82%)
GLOBAL_ASM remaining    258400 / 944352  (27.36%)
...
| game code, TU identified | 1019 | 796 | 73 | 150 | `████████████████▓░░░` 85.3% |
| game code, not yet split | 142 | 0 | 2 | 140 | `▓░░░░░░░░░░░░░░░░░░░` 1.4% |
| **total** | 1461 | 1067 | 104 | 290 | `███████████████▓░░░░` 80.2% |
...
**Source organization**: 598 fully-C translation units and 241 C scaffolds that still include assembly: 151 under `src/libultra/`; 52 under `src/main/`, including `matrix.c` (matrix/vector maths) and `runlink.c` (the runtime overlay linker core); 636 across 106 `src/overlays/oNNN/` directories (largest: `o101` 71, `o014` 28, `o011` 26, `o057` 22, `o084` 22).
