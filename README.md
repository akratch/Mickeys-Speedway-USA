...
[![functions](https://img.shields.io/badge/functions_matched-1003_of_1461_(68.65%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-350284_of_945760_(37.04%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1272_adopted-blue)](#progress)

```
functions     1003 / 1461    68.65%   matched to C, byte-identical
.text bytes 223524 / 476496  46.91%   matched C in the resident segment
verified asm  17184 / 476496   3.61%   original hand-written assembly (84 functions)
overlay C   109576 / 469264  23.35%   matched C keyed by overlay and offset
whole resolved 350284 / 945760  37.04%   resident C + verified asm + overlay C
named         1127 / 1461    77.14%   functions carrying an adopted name
...
```
decompiled              333100 / 945760  (35.22%)
handwritten asm          17184 / 945760  ( 1.82%)
GLOBAL_ASM remaining    281188 / 945760  (29.73%)
NON_MATCHING            314288 / 945760  (33.23%)
NON_EQUIVALENT               0 / 945760  ( 0.00%)
```

| Area | Functions | Matched to C | Named, still asm | Unnamed | Identified |
| :--- | ---: | ---: | ---: | ---: | :--- |
| libultra corridor | 288 | 254 | 33 | 1 | `██████████████████▓▓` 99.7% |
| game code, TU identified | 999 | 749 | 86 | 164 | `███████████████▓▓░░░` 83.6% |
| game code, not yet split | 174 | 0 | 5 | 169 | `▓░░░░░░░░░░░░░░░░░░░` 2.9% |
| **total** | 1461 | 1003 | 124 | 334 | `██████████████▓░░░░░` 77.1% |
