...
[![functions](https://img.shields.io/badge/functions_matched-1001_of_1463_(68.42%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-348616_of_947408_(36.80%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1272_adopted-blue)](#progress)

```
functions     1001 / 1463    68.42%   matched to C, byte-identical
.text bytes 221856 / 478144  46.40%   matched C in the resident segment
...
whole resolved 348616 / 947408  36.80%   resident C + verified asm + overlay C
...
```
decompiled              331432 / 947408  (34.98%)
handwritten asm          17184 / 947408  ( 1.81%)
GLOBAL_ASM remaining    284504 / 947408  (30.03%)
...
| game code, TU identified | 990 | 749 | 83 | 158 | `███████████████▓▓░░░` 84.0% |
