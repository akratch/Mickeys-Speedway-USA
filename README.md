...
[![functions](https://img.shields.io/badge/functions_matched-1045_of_1460_(71.58%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-378432_of_944348_(40.07%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1301_adopted-blue)](#progress)

```
functions     1045 / 1460    71.58%   matched to C, byte-identical
.text bytes 237904 / 475084  50.08%   matched C in the resident segment
...
whole resolved 378432 / 944348  40.07%   resident C + verified asm + overlay C
...
```
decompiled              361248 / 944348  (38.25%)
handwritten asm          17184 / 944348  ( 1.82%)
GLOBAL_ASM remaining    265396 / 944348  (28.10%)
