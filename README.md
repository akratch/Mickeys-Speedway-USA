...
[![functions](https://img.shields.io/badge/functions_matched-1002_of_1464_(68.44%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-349172_of_947796_(36.84%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1272_adopted-blue)](#progress)

```
functions     1002 / 1464    68.44%   matched to C, byte-identical
.text bytes 222708 / 478532  46.54%   matched C in the resident segment
...
whole resolved 349172 / 947796  36.84%   resident C + verified asm + overlay C
...
```
decompiled              332560 / 947796  (35.09%)
handwritten asm          16612 / 947796  ( 1.75%)
GLOBAL_ASM remaining    284612 / 947796  (30.03%)
...
| game code, TU identified | 991 | 750 | 83 | 158 | `███████████████▓▓░░░` 84.1% |
| game code, not yet split | 184 | 0 | 9 | 175 | `▓░░░░░░░░░░░░░░░░░░░` 4.9% |
| **total** | 1464 | 1002 | 126 | 336 | `██████████████▓░░░░░` 77.0% |
