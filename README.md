...
[![functions](https://img.shields.io/badge/functions_matched-1061_of_1460_(72.67%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-384964_of_944356_(40.76%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1324_adopted-blue)](#progress)

```
functions     1061 / 1460    72.67%   matched to C, byte-identical
.text bytes 243108 / 475092  51.17%   matched C in the resident segment
...
whole resolved 384964 / 944356  40.76%   resident C + verified asm + overlay C
...
```
decompiled              367780 / 944356  (38.95%)
handwritten asm          17184 / 944356  ( 1.82%)
GLOBAL_ASM remaining    260200 / 944356  (27.55%)
...
| game code, TU identified | 1068 | 791 | 74 | 203 | `███████████████▓░░░░` 81.0% |
