...
| game code, TU identified | 1045 | 796 | 73 | 176 | `███████████████▓▓░░░` 83.2% |
| game code, not yet split | 116 | 0 | 3 | 113 | `▓░░░░░░░░░░░░░░░░░░░` 2.6% |
...
**Source organization**: 595 fully-C translation units and 245 C scaffolds that still include assembly: 150 under `src/libultra/`; 54 under `src/main/`, including `matrix.c` (matrix/vector maths) and `runlink.c` (the runtime overlay linker core); 636 across 106 `src/overlays/oNNN/` directories (largest: `o101` 71, `o014` 28, `o011` 26, `o057` 22, `o084` 22).
