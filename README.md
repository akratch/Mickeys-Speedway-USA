...
[![functions](https://img.shields.io/badge/functions_matched-1034_of_1460_(70.82%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-362588_of_944356_(38.40%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1283_adopted-blue)](#progress)

```
functions     1034 / 1460    70.82%   matched to C, byte-identical
.text bytes 231780 / 475092  48.79%   matched C in the resident segment
verified asm  17184 / 475092   3.62%   original hand-written assembly (84 functions)
overlay C   113624 / 469264  24.21%   matched C keyed by overlay and offset
whole resolved 362588 / 944356  38.40%   resident C + verified asm + overlay C
named         1142 / 1460    78.22%   functions carrying an adopted name
...
```
decompiled              345404 / 944356  (36.58%)
handwritten asm          17184 / 944356  ( 1.82%)
GLOBAL_ASM remaining    271528 / 944356  (28.75%)
NON_MATCHING            310240 / 944356  (32.85%)
...
| game code, TU identified | 1003 | 777 | 74 | 152 | `███████████████▓▓░░░` 84.8% |
| game code, not yet split | 169 | 0 | 3 | 166 | `▓░░░░░░░░░░░░░░░░░░░` 1.8% |
| **total** | 1460 | 1034 | 108 | 318 | `██████████████▓▓░░░░` 78.2% |
