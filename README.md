...
[![functions](https://img.shields.io/badge/functions_matched-1071_of_1461_(73.31%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-387476_of_944412_(41.03%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1333_adopted-blue)](#progress)

```
functions     1071 / 1461    73.31%   matched to C, byte-identical
.text bytes 245620 / 475148  51.69%   matched C in the resident segment
verified asm  17184 / 475148   3.62%   original hand-written assembly (84 functions)
overlay C   124672 / 469264  26.57%   matched C keyed by overlay and offset
whole resolved 387476 / 944412  41.03%   resident C + verified asm + overlay C
named         1175 / 1461    80.42%   functions carrying an adopted name
...
```
decompiled              370292 / 944412  (39.21%)
handwritten asm          17184 / 944412  ( 1.82%)
GLOBAL_ASM remaining    257744 / 944412  (27.29%)
NON_MATCHING            299192 / 944412  (31.68%)
NON_EQUIVALENT               0 / 944412  ( 0.00%)
```

| Area | Functions | Matched to C | Named, still asm | Unnamed | Identified |
| :--- | ---: | ---: | ---: | ---: | :--- |
| libultra corridor | 301 | 271 | 29 | 1 | `██████████████████▓▓` 99.7% |
| game code, TU identified | 1028 | 800 | 73 | 155 | `████████████████▓░░░` 84.9% |
| game code, not yet split | 132 | 0 | 2 | 130 | `▓░░░░░░░░░░░░░░░░░░░` 1.5% |
| **total** | 1461 | 1071 | 104 | 286 | `███████████████▓░░░░` 80.4% |
...
**Source organization**: 598 fully-C translation units and 244 C scaffolds that still include assembly: 152 under `src/libultra/`; 54 under `src/main/`, including `matrix.c` (matrix/vector maths) and `runlink.c` (the runtime overlay linker core); 636 across 106 `src/overlays/oNNN/` directories (largest: `o101` 71, `o014` 28, `o011` 26, `o057` 22, `o084` 22).
