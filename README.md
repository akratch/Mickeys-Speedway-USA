...
[![functions](https://img.shields.io/badge/functions_matched-1193_of_1461_(81.66%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-470364_of_944348_(49.81%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1420_adopted-blue)](#progress)

```
functions     1193 / 1461    81.66%   matched to C, byte-identical
.text bytes 289872 / 475084  61.01%   matched C in the resident segment
...
whole resolved 470364 / 944348  49.81%   resident C + verified asm + overlay C
