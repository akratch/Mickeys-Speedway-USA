...
[![functions](https://img.shields.io/badge/functions_matched-1038_of_1460_(71.10%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-367824_of_944356_(38.95%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1284_adopted-blue)](#progress)

```
functions     1038 / 1460    71.10%   matched to C, byte-identical
.text bytes 233560 / 475092  49.16%   matched C in the resident segment
...
whole resolved 367824 / 944356  38.95%   resident C + verified asm + overlay C
named         1145 / 1460    78.42%   functions carrying an adopted name
...
```
decompiled              350640 / 944356  (37.13%)
handwritten asm          17184 / 944356  ( 1.82%)
GLOBAL_ASM remaining    269748 / 944356  (28.56%)
NON_MATCHING            306784 / 944356  (32.49%)
...
| game code, TU identified | 1003 | 781 | 73 | 149 | `████████████████▓░░░` 85.1% |
| game code, not yet split | 169 | 0 | 3 | 166 | `▓░░░░░░░░░░░░░░░░░░░` 1.8% |
| **total** | 1460 | 1038 | 107 | 315 | `██████████████▓▓░░░░` 78.4% |
