...
[![functions](https://img.shields.io/badge/functions_matched-1197_of_1461_(81.93%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-472352_of_944348_(50.02%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1420_adopted-blue)](#progress)

```
functions     1197 / 1461    81.93%   matched to C, byte-identical
.text bytes 291860 / 475084  61.43%   matched C in the resident segment
...
whole resolved 472352 / 944348  50.02%   resident C + verified asm + overlay C
