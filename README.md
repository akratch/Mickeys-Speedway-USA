...
[![functions](https://img.shields.io/badge/functions_matched-1171_of_1461_(80.15%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-430192_of_944356_(45.55%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1407_adopted-blue)](#progress)

```
functions     1171 / 1461    80.15%   matched to C, byte-identical
.text bytes 273684 / 475092  57.61%   matched C in the resident segment
...
whole resolved 430192 / 944356  45.55%   resident C + verified asm + overlay C
