...
[![functions](https://img.shields.io/badge/functions_matched-1188_of_1461_(81.31%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-467028_of_944348_(49.46%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1419_adopted-blue)](#progress)

```
functions     1188 / 1461    81.31%   matched to C, byte-identical
.text bytes 287972 / 475084  60.61%   matched C in the resident segment
...
whole resolved 467028 / 944348  49.46%   resident C + verified asm + overlay C
named         1285 / 1461    87.95%   functions carrying an adopted name
symbols       1419                    adopted in symbol_addrs.us.txt
```
...
```
decompiled              449844 / 944348  (47.64%)
handwritten asm          17184 / 944348  ( 1.82%)
GLOBAL_ASM remaining     11548 / 944348  ( 1.22%)
NON_MATCHING            465772 / 944348  (49.32%)
...
| game code, TU identified | 1153 | 917 | 68 | 168 | `████████████████▓░░░` 85.4% |
| game code, not yet split | 7 | 0 | 0 | 7 | `░░░░░░░░░░░░░░░░░░░░` 0.0% |
| **total** | 1461 | 1188 | 97 | 176 | `████████████████▓▓░░` 88.0% |
