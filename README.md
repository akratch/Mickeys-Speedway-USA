...
[![functions](https://img.shields.io/badge/functions_matched-1040_of_1460_(71.23%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-368988_of_944348_(39.07%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1290_adopted-blue)](#progress)
...
overlay C   116200 / 469264  24.76%   matched C keyed by overlay and offset
whole resolved 368988 / 944348  39.07%   resident C + verified asm + overlay C
named         1147 / 1460    78.56%   functions carrying an adopted name
symbols       1290                    adopted in symbol_addrs.us.txt
```
