...
[![functions](https://img.shields.io/badge/functions_matched-1048_of_1460_(71.78%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-380288_of_944348_(40.27%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1302_adopted-blue)](#progress)

```
functions     1048 / 1460    71.78%   matched to C, byte-identical
.text bytes 239760 / 475084  50.47%   matched C in the resident segment
...
whole resolved 380288 / 944348  40.27%   resident C + verified asm + overlay C
...
```
decompiled              363104 / 944348  (38.45%)
handwritten asm          17184 / 944348  ( 1.82%)
GLOBAL_ASM remaining    263540 / 944348  (27.91%)
