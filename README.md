...
[![functions](https://img.shields.io/badge/functions_matched-1073_of_1460_(73.49%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-387192_of_944352_(41.00%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1355_adopted-blue)](#progress)

```
functions     1073 / 1460    73.49%   matched to C, byte-identical
.text bytes 245336 / 475088  51.64%   matched C in the resident segment
...
whole resolved 387192 / 944352  41.00%   resident C + verified asm + overlay C
named         1178 / 1460    80.68%   functions carrying an adopted name
symbols       1355                    adopted in symbol_addrs.us.txt
```
...
```
decompiled              370008 / 944352  (39.18%)
handwritten asm          17184 / 944352  ( 1.82%)
GLOBAL_ASM remaining    257968 / 944352  (27.32%)
...
| game code, TU identified | 1051 | 803 | 73 | 175 | `███████████████▓▓░░░` 83.3% |
| game code, not yet split | 110 | 0 | 3 | 107 | `▓░░░░░░░░░░░░░░░░░░░` 2.7% |
| **total** | 1460 | 1073 | 105 | 282 | `███████████████▓░░░░` 80.7% |
