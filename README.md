...
[![functions](https://img.shields.io/badge/functions_matched-1050_of_1460_(71.92%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-380880_of_944348_(40.33%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1304_adopted-blue)](#progress)

```
functions     1050 / 1460    71.92%   matched to C, byte-identical
.text bytes 240352 / 475084  50.59%   matched C in the resident segment
...
whole resolved 380880 / 944348  40.33%   resident C + verified asm + overlay C
named         1155 / 1460    79.11%   functions carrying an adopted name
symbols       1304                    adopted in symbol_addrs.us.txt
```
...
```
decompiled              363696 / 944348  (38.51%)
handwritten asm          17184 / 944348  ( 1.82%)
GLOBAL_ASM remaining    262948 / 944348  (27.84%)
