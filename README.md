...
[![functions](https://img.shields.io/badge/functions_matched-1145_of_1461_(78.37%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-405648_of_944416_(42.95%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1385_adopted-blue)](#progress)

```
functions     1145 / 1461    78.37%   matched to C, byte-identical
.text bytes 255420 / 475152  53.76%   matched C in the resident segment
...
whole resolved 405648 / 944416  42.95%   resident C + verified asm + overlay C
...
```
decompiled              388464 / 944416  (41.13%)
handwritten asm          17184 / 944416  ( 1.82%)
GLOBAL_ASM remaining    214596 / 944416  (22.72%)
...
| game code, TU identified | 1153 | 874 | 73 | 206 | `███████████████▓░░░░` 82.1% |
