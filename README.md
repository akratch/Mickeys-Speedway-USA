...
[![functions](https://img.shields.io/badge/functions_matched-1102_of_1460_(75.48%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-389156_of_944376_(41.21%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1363_adopted-blue)](#progress)

```
functions     1102 / 1460    75.48%   matched to C, byte-identical
.text bytes 247300 / 475112  52.05%   matched C in the resident segment
...
whole resolved 389156 / 944376  41.21%   resident C + verified asm + overlay C
named         1205 / 1460    82.53%   functions carrying an adopted name
...
```
decompiled              371972 / 944376  (39.39%)
handwritten asm          17184 / 944376  ( 1.82%)
GLOBAL_ASM remaining    256028 / 944376  (27.11%)
NON_MATCHING            299192 / 944376  (31.68%)
...
| game code, TU identified | 1137 | 832 | 73 | 232 | `███████████████▓░░░░` 79.6% |
| game code, not yet split | 24 | 0 | 1 | 23 | `▓░░░░░░░░░░░░░░░░░░░` 4.2% |
| **total** | 1460 | 1102 | 103 | 255 | `███████████████▓▓░░░` 82.5% |
