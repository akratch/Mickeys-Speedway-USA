...
[![functions](https://img.shields.io/badge/functions_matched-1060_of_1460_(72.60%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-385344_of_944356_(40.80%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1327_adopted-blue)](#progress)

```
functions     1060 / 1460    72.60%   matched to C, byte-identical
.text bytes 243488 / 475092  51.25%   matched C in the resident segment
...
whole resolved 385344 / 944356  40.80%   resident C + verified asm + overlay C
named         1165 / 1460    79.79%   functions carrying an adopted name
symbols       1327                    adopted in symbol_addrs.us.txt
```
...
```
decompiled              368160 / 944356  (38.99%)
handwritten asm          17184 / 944356  ( 1.82%)
GLOBAL_ASM remaining    259820 / 944356  (27.51%)
...
| game code, TU identified | 1012 | 790 | 73 | 149 | `████████████████▓░░░` 85.3% |
| game code, not yet split | 149 | 0 | 3 | 146 | `▓░░░░░░░░░░░░░░░░░░░` 2.0% |
| **total** | 1460 | 1060 | 105 | 295 | `███████████████▓░░░░` 79.8% |
