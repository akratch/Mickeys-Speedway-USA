...
[![functions](https://img.shields.io/badge/functions_matched-1062_of_1460_(72.74%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-384980_of_944356_(40.77%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1324_adopted-blue)](#progress)

```
functions     1062 / 1460    72.74%   matched to C, byte-identical
.text bytes 243124 / 475092  51.17%   matched C in the resident segment
...
whole resolved 384980 / 944356  40.77%   resident C + verified asm + overlay C
...
```
decompiled              367796 / 944356  (38.95%)
handwritten asm          17184 / 944356  ( 1.82%)
GLOBAL_ASM remaining    260184 / 944356  (27.55%)
...
| game code, TU identified | 1068 | 792 | 74 | 202 | `███████████████▓░░░░` 81.1% |
