...
[![functions](https://img.shields.io/badge/functions_matched-1184_of_1461_(81.04%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-442716_of_944348_(46.88%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1419_adopted-blue)](#progress)

```
functions     1184 / 1461    81.04%   matched to C, byte-identical
.text bytes 285656 / 475084  60.13%   matched C in the resident segment
...
whole resolved 442716 / 944348  46.88%   resident C + verified asm + overlay C
