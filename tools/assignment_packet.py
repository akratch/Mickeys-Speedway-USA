...
def main() -> int:
    ...
    add("newly proved identity, or an eliminated hypothesis, and stop after three")
    add("consecutive attempts that buy none of those. Record that stall as the")
    add("stopping evidence. A monotonically improving series is a reason to")
    add("continue while the wall clock holds. Conversely, stop early — with zero")
