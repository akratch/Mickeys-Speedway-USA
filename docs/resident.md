...
| `func_80002188` | `0x2D88` / `0x1CC` | **tier B:** DKR's public SGI `__amDMA` body supplies the DMA-list search/allocation shape; Mickey's DMA state and calls remain authoritative | Permuter-ready operand shape: 7 differing words of 115, exact frame/opcodes/registers; first `+0x28`, stack-home allocation remains |
