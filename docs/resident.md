...
| `func_8000238C` | `0x2C8C` / `0x130` | **tier A:** DKR's public SGI `__clearAudioDMA` body supplies the DMA-list cleanup shape; Mickey's queue and DMA state remain authoritative | Exact 76 object words and linked ROM bytes |
