...
| `func_8000AA38` | `0xB638` / `0x4B4` | **tier A**: Mickey-only instruction, table-destination, runtime-call and ABI proof; placeholder retained | Exact 301 linked C words, 24-byte frame, 74 relocation sites/identities, 92 retained table destinations, and full ROM; caller forwards the third preserve-state parameter |
