...
| 35 | `src/overlays/o047/overlay47ReleaseResources.c` | `func_overlay_047_F00009D0_18917E8` | `o047` | `other` | 352 | 14 | 6 | 24 | 176 | 0 | — |
...
| 38 | `src/overlays/o036/overlay36CheckNearbyHeight.c` | `func_overlay_036_F0000818_1883CD0` | `o036` | `other` | 252 | 8 | 7 | 0 | 0 | 0 | — |
| 39 | `src/overlays/o062/overlay62Update.c` | `overlay62Update` | `o062` | `other` | 1,176 | 8 | 7 | 68 | 68 | 0 | — |
...
| 42 | `src/main/audiomgr.c` | `func_80002134` | `main` | `other` | 84 | 9 | 9 | 24 | 24 | 0 | — |
...
| 52 | `src/overlays/o001/overlay_001_tail.c` | `overlay1AssignRecordIndex` | `o001` | `other` | 176 | 11 | 11 | 68 | 68 | 0 | — |
| 53 | `src/overlays/o026/overlay26HandleEffects.c` | `func_overlay_026_F0000D24_187B11C` | `o026` | `other` | 1,076 | 11 | 11 | 0 | 0 | 0 | — |
| 54 | `src/overlays/o094/overlay94UpdateController.c` | `overlay94UpdateController` | `o094` | `other` | 1,100 | 22 | 11 | 28 | 56 | 0 | — |
| 55 | `src/main/block_4F4E0.c` | `func_8004E8E0` | `main` | `other` | 188 | 12 | 12 | 52 | 52 | 0 | — |
| 56 | `src/main/menu_3B1A0.c` | `func_8003A754` | `main` | `other` | 124 | 12 | 12 | 16 | 16 | 0 | — |
| 57 | `src/overlays/o001/overlay_001_tail.c` | `overlay1FindBestRecord` | `o001` | `other` | 120 | 12 | 12 | 4 | 4 | 0 | — |
| 58 | `src/overlays/o001/overlay_001.c` | `overlay1FindPreviousUsable` | `o001` | `other` | 160 | 14 | 12 | 4 | 20 | 0 | — |
...
| 61 | `src/overlays/o015/overlay_015.c` | `overlay15DrawRain` | `o015` | `other` | 216 | 18 | 13 | 8 | 116 | 0 | — |
| 62 | `src/main/fx.c` | `func_8004ACC4` | `main` | `other` | 112 | 14 | 14 | 20 | 20 | 0 | — |
| 63 | `src/main/memory.c` | `func_8002B524` | `main` | `other` | 464 | 14 | 14 | 224 | 224 | 0 | — |
| 64 | `src/overlays/o014/overlay14CreateValue.c` | `overlay14CreateValue` | `o014` | `other` | 384 | 15 | 14 | 84 | 164 | 0 | — |
| 65 | `src/overlays/o029/overlay29InitializeObject.c` | `func_overlay_029_F000042C_187D6DC` | `o029` | `other` | 408 | 15 | 15 | 20 | 20 | 0 | — |
| 66 | `src/overlays/o041/overlay41UpdateColorRecords.c` | `func_overlay_041_F0000124_188745C` | `o041` | `other` | 392 | 20 | 15 | 48 | 64 | 0 | — |
| 67 | `src/overlays/o001/overlay_001_tail.c` | `overlay1InitializeGaugeObjects` | `o001` | `other` | 296 | 16 | 16 | 48 | 48 | 0 | — |
| 68 | `src/overlays/o017/overlay17DrawStrip.c` | `overlay17DrawStrip` | `o017` | `other` | 476 | 16 | 16 | 0 | 0 | 0 | — |
| 69 | `src/overlays/o043/overlay43FilterImage.c` | `overlay43FilterImage` | `o043` | `other` | 172 | 16 | 16 | 4 | 4 | 0 | — |
| 70 | `src/overlays/o007/overlay_007.c` | `overlay7AcquireEntry` | `o007` | `other` | 384 | 17 | 16 | 8 | 260 | 0 | — |
| 71 | `src/main/anim.c` | `func_8005716C` | `main` | `other` | 320 | 18 | 18 | 84 | 84 | 0 | — |
| 72 | `src/overlays/o001/overlay_001.c` | `overlay1FindType47ByAngle` | `o001` | `other` | 296 | 19 | 18 | 8 | 8 | 0 | — |
| 73 | `src/main/menu_3B1A0.c` | `func_8003A5A0` | `main` | `other` | 224 | 19 | 19 | 0 | 0 | 0 | — |
| 74 | `src/main/objects.c` | `func_800069E8` | `main` | `other` | 284 | 19 | 19 | 140 | 140 | 0 | — |
| 75 | `src/overlays/o027/overlay_027.c` | `overlay27UpdateCoordinates` | `o027` | `other` | 260 | 19 | 19 | 0 | 0 | 0 | — |
| 76 | `src/overlays/o075/overlay75UpdateMovingObject.c` | `overlay75UpdateMovingObject` | `o075` | `other` | 1,216 | 19 | 19 | 84 | 84 | 0 | — |
| 77 | `src/overlays/o059/overlay59Advance.c` | `overlay59Advance` | `o059` | `other` | 1,048 | 22 | 19 | 4 | 4 | 0 | — |
| 78 | `src/main/particles.c` | `func_8003F154` | `main` | `other` | 1,188 | 21 | 21 | 524 | 524 | 0 | — |
| 79 | `src/overlays/o003/overlay3SelectScoredObject.c` | `overlay3SelectScoredObject` | `o003` | `other` | 472 | 21 | 21 | 72 | 72 | 0 | — |
| 80 | `src/overlays/o001/overlay_001_tail.c` | `overlay1AppendPathPoint` | `o001` | `other` | 432 | 22 | 21 | 32 | 32 | 0 | — |
| 81 | `src/overlays/o033/overlay33PresentAndSwap.c` | `overlay33PresentAndSwap` | `o033` | `other` | 156 | 22 | 21 | 16 | 16 | 0 | — |
| 82 | `src/overlays/o060/overlay60Initialize.c` | `func_overlay_060_F0000000_18B9DD8` | `o060` | `other` | 820 | 46 | 21 | 124 | 124 | 0 | — |
| 83 | `src/main/fx.c` | `func_80048760` | `main` | `other` | 484 | 23 | 23 | 8 | 8 | 0 | — |
| 84 | `src/overlays/o001/overlay_001_tail.c` | `overlay1UpdateAimedTransient` | `o001` | `other` | 996 | 32 | 23 | 0 | 0 | 0 | — |
...
| 90 | `src/main/fx.c` | `func_8004AF68` | `main` | `other` | 208 | 26 | 26 | 16 | 16 | 0 | — |
| 91 | `src/overlays/o001/overlay_001_middle.c` | `overlay1AdvanceGauge` | `o001` | `other` | 168 | 26 | 26 | 20 | 20 | 0 | — |
| 92 | `src/overlays/o092/overlay92FindNearestCourse.c` | `func_overlay_092_F0000068_18D5F88` | `o092` | `other` | 672 | 26 | 26 | 4 | 4 | 0 | — |
| 93 | `src/main/objects.c` | `func_80006448` | `main` | `other` | 236 | 27 | 27 | 28 | 28 | 0 | — |
| 94 | `src/overlays/o002/func_overlay_002_F0001A94_185888C.c` | `func_overlay_002_F0001A94_185888C` | `o002` | `other` | 868 | 51 | 27 | 76 | 312 | 0 | — |
| 95 | `src/main/block_4F4E0.c` | `func_8004EED0` | `main` | `other` | 336 | 28 | 28 | 168 | 168 | 0 | — |
| 96 | `src/main/objects.c` | `func_80008028` | `main` | `other` | 240 | 28 | 28 | 36 | 36 | 0 | — |
| 97 | `src/main/charControl.c` | `func_8001D880` | `main` | `other` | 144 | 29 | 29 | 4 | 4 | 0 | — |
| 98 | `src/overlays/o041/overlay41EnqueueTransition.c` | `func_overlay_041_F000195C_1888C94` | `o041` | `other` | 420 | 29 | 29 | 8 | 8 | 0 | — |
| 99 | `src/overlays/o034/overlay34CreateRecord.c` | `overlay34CreateRecord` | `o034` | `other` | 500 | 32 | 30 | 0 | 0 | 0 | — |
| 100 | `src/overlays/o001/overlay_001_tail.c` | `overlay1ConsumeNearbyPending` | `o001` | `other` | 276 | 31 | 31 | 64 | 64 | 0 | — |
| 101 | `src/overlays/o001/overlay_001_tail.c` | `overlay1UpdateRangeFlags` | `o001` | `other` | 480 | 31 | 31 | 160 | 160 | 0 | — |
| 102 | `src/overlays/o098/overlay98CollectUniqueY.c` | `overlay98CollectUniqueY` | `o098` | `other` | 324 | 32 | 32 | 104 | 104 | 0 | — |
| 103 | `src/overlays/o029/overlay29HandleEffects.c` | `func_overlay_029_F00010C4_187E374` | `o029` | `other` | 1,028 | 33 | 33 | 124 | 124 | 0 | — |
| 104 | `src/overlays/o071/func_overlay_071_F0000870_18CA390.c` | `func_overlay_071_F0000870_18CA390` | `o071` | `other` | 728 | 33 | 33 | 112 | 112 | 0 | — |
| 105 | `src/main/saves.c` | `packInit` | `main` | `other` | 460 | 34 | 34 | 160 | 160 | 0 | — |
| 106 | `src/overlays/o003/overlay3RunCachedModeAction.c` | `overlay3RunCachedModeAction` | `o003` | `other` | 452 | 34 | 34 | 132 | 132 | 0 | — |
| 107 | `src/overlays/o041/overlay41UpdateProgress.c` | `func_overlay_041_F0001298_18885D0` | `o041` | `other` | 460 | 34 | 34 | 232 | 232 | 0 | — |
| 108 | `src/overlays/o060/overlay60ReassignChoiceSlots.c` | `overlay60ReassignChoiceSlots` | `o060` | `other` | 212 | 35 | 35 | 4 | 4 | 0 | — |
| 109 | `src/overlays/o098/overlay98CheckObject.c` | `overlay98CheckObject` | `o098` | `other` | 444 | 35 | 35 | 56 | 56 | 0 | — |
...
| 117 | `src/overlays/o008/overlay_008.c` | `func_overlay_008_F0004CF0_1862A48` | `o008` | `other` | 1,080 | 48 | 43 | 376 | 376 | 0 | — |
| 118 | `src/overlays/o033/overlay33BuildDisplayList.c` | `overlay33BuildDisplayList` | `o033` | `other` | 1,232 | 46 | 46 | 920 | 920 | 0 | — |
| 119 | `src/main/matrix.c` | `MatrixMultiplyVec4` | `main` | `other` | 212 | 47 | 47 | 0 | 0 | 0 | — |
| 120 | `src/overlays/o029/overlay29DrawGroups.c` | `overlay29DrawGroups` | `o029` | `other` | 516 | 47 | 47 | 76 | 76 | 0 | — |
| 121 | `src/overlays/o001/overlay_001.c` | `overlay1ActivateObject` | `o001` | `other` | 352 | 50 | 47 | 0 | 0 | 0 | — |
| 122 | `src/main/joy.c` | `joyRead` | `main` | `other` | 636 | 49 | 48 | 24 | 24 | 0 | — |
| 123 | `src/overlays/o008/overlay_008.c` | `func_overlay_008_F0000894_185E5EC` | `o008` | `other` | 1,524 | 57 | 48 | 204 | 1,064 | 0 | — |
| 124 | `src/overlays/o099/overlay99RenderSortedEntries.c` | `overlay99RenderSortedEntries` | `o099` | `other` | 932 | 51 | 49 | 0 | 0 | 0 | — |
| 125 | `src/main/anim.c` | `func_8005776C` | `main` | `other` | 420 | 51 | 51 | 36 | 36 | 0 | — |
...
| 131 | `src/main/objects.c` | `func_80009220` | `main` | `other` | 500 | 55 | 55 | 28 | 28 | 0 | — |
| 132 | `src/overlays/o008/overlay_008.c` | `func_overlay_008_F000291C_1860674` | `o008` | `other` | 1,444 | 60 | 56 | 0 | 0 | 0 | — |
| 133 | `src/overlays/o089/overlay89InitializeEffect.c` | `overlay89InitializeEffect` | `o089` | `other` | 820 | 58 | 58 | 64 | 64 | 0 | — |
| 134 | `src/overlays/o035/overlay35BuildGridMasks.c` | `func_overlay_035_F0000770_1882450` | `o035` | `other` | 976 | 59 | 59 | 44 | 44 | 0 | — |
| 135 | `src/main/spranim.c` | `effectboxControl` | `main` | `other` | 772 | 60 | 60 | 72 | 72 | 0 | — |
| 136 | `src/overlays/o057/overlay57Draw32A0.c` | `overlay57Draw32A0` | `o057` | `other` | 832 | 63 | 60 | 0 | 0 | 0 | — |
| 137 | `src/main/objects.c` | `func_8000BB84` | `main` | `other` | 260 | 61 | 61 | 0 | 0 | 0 | — |
| 138 | `src/main/diCpu.c` | `render_epc_lock_up_display` | `main` | `other` | 1,376 | 62 | 62 | 324 | 324 | 0 | — |
| 139 | `src/overlays/o101/overlay101DrawTransformed.c` | `overlay101DrawTransformed` | `o101` | `other` | 664 | 62 | 62 | 124 | 124 | 0 | — |
| 140 | `src/overlays/o008/overlay_008.c` | `func_overlay_008_F0002640_1860398` | `o008` | `other` | 732 | 63 | 62 | 184 | 184 | 0 | — |
| 141 | `src/overlays/o027/overlay_027.c` | `func_overlay_027_F0000064_187BA3C` | `o027` | `other` | 1,472 | 63 | 62 | 24 | 24 | 0 | — |
| 142 | `src/main/objects.c` | `func_80006FA0` | `main` | `other` | 376 | 63 | 63 | 12 | 12 | 0 | — |
| 143 | `src/overlays/o019/overlay19BuildSpatialMasks.c` | `overlay19BuildSpatialMasks` | `o019` | `other` | 908 | 63 | 63 | 88 | 88 | 0 | — |
| 144 | `src/main/saves.c` | `rumbleTick` | `main` | `other` | 1,372 | 64 | 64 | 244 | 244 | 0 | — |
| 145 | `src/overlays/o014/overlay14PrepareInputState.c` | `overlay14PrepareInputState` | `o014` | `other` | 524 | 67 | 65 | 52 | 52 | 0 | — |
| 146 | `src/main/menu.c` | `func_80038878` | `main` | `other` | 340 | 66 | 66 | 20 | 20 | 0 | — |
| 147 | `src/main/fx.c` | `func_80049000` | `main` | `other` | 596 | 69 | 69 | 0 | 0 | 0 | — |
| 148 | `src/overlays/o058/overlay58DrawLargePointQuad.c` | `overlay58DrawLargePointQuad` | `o058` | `other` | 416 | 70 | 70 | 48 | 48 | 0 | — |
| 149 | `src/overlays/o058/overlay58DrawPointQuad.c` | `overlay58DrawPointQuad` | `o058` | `other` | 416 | 70 | 70 | 48 | 48 | 0 | — |
| 150 | `src/main/gameVi.c` | `func_800336A8` | `main` | `other` | 780 | 71 | 71 | 0 | 0 | 0 | — |
| 151 | `src/overlays/o036/overlay36ChooseWeightedState.c` | `func_overlay_036_F0000A60_1883F18` | `o036` | `other` | 680 | 71 | 71 | 60 | 60 | 0 | — |
| 152 | `src/overlays/o083/overlay83DrawStrip.c` | `overlay83DrawStrip` | `o083` | `other` | 308 | 73 | 73 | 4 | 4 | 0 | — |
| 153 | `src/overlays/o086/func_overlay_086_F0000474_18D22AC.c` | `func_overlay_086_F0000474_18D22AC` | `o086` | `other` | 2,648 | 73 | 73 | 112 | 112 | 0 | — |
| 154 | `src/main/lights.c` | `func_80018F08` | `main` | `other` | 820 | 75 | 75 | 0 | 0 | 0 | — |
| 155 | `src/overlays/o040/overlay40BuildFrame.c` | `overlay40BuildFrame` | `o040` | `other` | 324 | 75 | 75 | 4 | 4 | 0 | — |
| 156 | `src/overlays/o101/overlay101DrawPanel.c` | `overlay101DrawPanel` | `o101` | `other` | 1,072 | 79 | 79 | 180 | 180 | 0 | — |
| 157 | `src/overlays/o007/overlay_007_tail.c` | `overlay7UpdateOwnerMode` | `o007` | `other` | 556 | 81 | 81 | 16 | 16 | 0 | — |
| 158 | `src/overlays/o014/func_overlay_014_F0001540_1870E18.c` | `func_overlay_014_F0001540_1870E18` | `o014` | `other` | 752 | 83 | 82 | 136 | 136 | 0 | — |
| 159 | `src/overlays/o060/func_overlay_060_F0002F54_18BCD2C.c` | `func_overlay_060_F0002F54_18BCD2C` | `o060` | `other` | 888 | 84 | 84 | 100 | 100 | 0 | — |
| 160 | `src/overlays/o015/overlay_015.c` | `overlay15InitStars` | `o015` | `other` | 760 | 89 | 89 | 124 | 124 | 0 | — |
| 161 | `src/main/fx.c` | `func_800470B0` | `main` | `other` | 596 | 90 | 90 | 68 | 68 | 0 | — |
| 162 | `src/overlays/o057/overlay57SmoothAndCheckDistance.c` | `overlay57SmoothAndCheckDistance` | `o057` | `other` | 800 | 97 | 92 | 36 | 36 | 0 | — |
| 163 | `src/overlays/o057/overlay57EaseAndLatch.c` | `overlay57EaseAndLatch` | `o057` | `other` | 884 | 101 | 92 | 20 | 44 | 0 | — |
| 164 | `src/overlays/o038/func_overlay_038_F000047C_188618C.c` | `func_overlay_038_F000047C_188618C` | `o038` | `other` | 876 | 93 | 93 | 192 | 192 | 0 | — |
| 165 | `src/overlays/o031/overlay31BuildLookupTables.c` | `func_overlay_031_F0000000_187F520` | `o031` | `other` | 744 | 94 | 94 | 52 | 52 | 0 | — |
| 166 | `src/overlays/o013/overlay13ProcessRecord.c` | `overlay13UpdateRecord` | `o013` | `other` | 644 | 96 | 96 | 44 | 44 | 0 | — |
| 167 | `src/overlays/o083/overlay83BuildBatch.c` | `overlay83BuildBatch` | `o083` | `other` | 672 | 97 | 97 | 0 | 0 | 0 | — |
| 168 | `src/overlays/o013/overlay13DrawRecord.c` | `overlay13DrawRecord` | `o013` | `other` | 756 | 100 | 97 | 48 | 84 | 0 | — |
| 169 | `src/overlays/o002/func_overlay_002_F0000C90_1857A88.c` | `func_overlay_002_F0000C90_1857A88` | `o002` | `other` | 1,420 | 108 | 98 | 0 | 0 | 0 | — |
| 170 | `src/overlays/o058/overlay58DrawSegmentStrip.c` | `overlay58DrawSegmentStrip` | `o058` | `other` | 804 | 102 | 102 | 12 | 12 | 0 | — |
| 171 | `src/overlays/o050/overlay50Initialize.c` | `func_overlay_050_F0000000_1896970` | `o050` | `other` | 740 | 112 | 104 | 60 | 192 | 0 | — |
| 172 | `src/overlays/o002/overlay2ChooseBoundary.c` | `overlay2ChooseBoundary` | `o002` | `other` | 1,168 | 112 | 106 | 92 | 92 | 0 | — |
| 173 | `src/overlays/o052/overlay52Initialize.c` | `func_overlay_052_F0000000_189A670` | `o052` | `other` | 1,264 | 119 | 115 | 44 | 44 | 0 | — |
| 174 | `src/overlays/o015/overlay_015.c` | `overlay15InitStarsAndPalette` | `o015` | `other` | 988 | 120 | 120 | 4 | 4 | 0 | — |
| 175 | `src/main/level.c` | `levelInit` | `main` | `other` | 2,064 | 122 | 122 | 0 | 0 | 0 | — |
...
| 183 | `src/main/charControl.c` | `func_8001CB84` | `main` | `other` | 1,820 | 138 | 138 | 0 | 0 | 0 | — |
...
| 190 | `src/main/objects.c` | `func_8000A39C` | `main` | `other` | 656 | 158 | 158 | 0 | 0 | 0 | — |
| 191 | `src/main/shadows.c` | `func_800180B4` | `main` | `other` | 824 | 159 | 159 | 52 | 52 | 0 | — |
...
| 194 | `src/main/menu.c` | `func_80039E34` | `main` | `other` | 1,048 | 161 | 161 | 20 | 20 | 0 | — |
| 195 | `src/overlays/o100/overlay100DrawMotion.c` | `overlay100DrawMotion` | `o100` | `other` | 972 | 161 | 161 | 0 | 0 | 0 | — |
| 196 | `src/main/track.c` | `func_8001398C` | `main` | `other` | 1,320 | 162 | 162 | 96 | 96 | 0 | — |
...
| 199 | `src/main/track.c` | `func_8000F198` | `main` | `other` | 996 | 185 | 185 | 0 | 0 | 0 | — |
| 200 | `src/main/track.c` | `func_800140CC` | `main` | `other` | 868 | 187 | 187 | 0 | 0 | 0 | — |
| 201 | `src/main/anim.c` | `func_80051364` | `main` | `other` | 1,148 | 192 | 192 | 0 | 0 | 0 | — |
...
| 224 | `src/main/charControl.c` | `func_8001DD70` | `main` | `other` | 2,132 | 430 | 430 | 0 | 0 | 0 | — |
...
| 253 | `src/main/block_4F4E0.c` | `func_8004EC60` | `main` | `size-mismatch` | 328 | 79 | 79 | 0 | 0 | 4 | — |
| 254 | `src/main/objects.c` | `func_80005548` | `main` | `size-mismatch` | 348 | 81 | 81 | 24 | 24 | -8 | — |
| 255 | `src/main/objects.c` | `func_8000831C` | `main` | `size-mismatch` | 424 | 81 | 81 | 64 | 64 | -4 | — |
| 256 | `src/main/matrix.c` | `func_8002AB78` | `main` | `size-mismatch` | 268 | 83 | 83 | 0 | 0 | 68 | — |
| 257 | `src/main/sched.c` | `__scHandleRetrace` | `main` | `size-mismatch` | 1,636 | 84 | 84 | 984 | 984 | -4 | — |
| 258 | `src/overlays/o015/overlay_015.c` | `overlay15UpdateMovingStars` | `o015` | `size-mismatch` | 412 | 87 | 84 | 36 | 48 | 28 | — |
| 259 | `src/overlays/o001/overlay_001_head.c` | `overlay1BuildObjectMappings` | `o001` | `size-mismatch` | 592 | 88 | 88 | 0 | 0 | -12 | — |
| 260 | `src/overlays/o026/overlay26DrawGroups.c` | `func_overlay_026_F0001158_187B550` | `o026` | `size-mismatch` | 536 | 88 | 88 | 76 | 76 | -4 | — |
| 261 | `src/main/diCpu.c` | `func_80046BCC` | `main` | `size-mismatch` | 424 | 89 | 89 | 44 | 44 | 4 | — |
| 262 | `src/main/matrix.c` | `func_8002AA50` | `main` | `size-mismatch` | 296 | 90 | 90 | 0 | 0 | 68 | — |
| 263 | `src/overlays/o001/overlay_001_tail.c` | `overlay1SolveAngleCandidates` | `o001` | `size-mismatch` | 556 | 92 | 92 | 168 | 168 | -8 | — |
| 264 | `src/main/frontend_37D50.c` | `func_800376CC` | `main` | `size-mismatch` | 472 | 95 | 95 | 0 | 0 | 4 | — |
| 265 | `src/main/objects.c` | `func_80004590` | `main` | `size-mismatch` | 396 | 96 | 96 | 0 | 0 | 20 | — |
| 266 | `src/main/models_5B300.c` | `func_8005ABA8` | `main` | `size-mismatch` | 444 | 97 | 97 | 56 | 56 | -4 | — |
| 267 | `src/main/track.c` | `func_800133FC` | `main` | `size-mismatch` | 384 | 98 | 98 | 0 | 0 | 12 | — |
| 268 | `src/overlays/o089/overlay89UpdateStateAndParticles.c` | `overlay89UpdateStateAndParticles` | `o089` | `size-mismatch` | 544 | 98 | 98 | 0 | 0 | 4 | — |
| 269 | `src/main/particles.c` | `func_8004054C` | `main` | `size-mismatch` | 500 | 101 | 101 | 44 | 44 | -4 | — |
| 270 | `src/overlays/o063/overlay63UpdateSequence.c` | `overlay63UpdateSequence` | `o063` | `size-mismatch` | 428 | 102 | 102 | 20 | 20 | -4 | — |
| 271 | `src/main/frontend_37D50.c` | `func_800378A4` | `main` | `size-mismatch` | 468 | 103 | 103 | 20 | 20 | -20 | — |
| 272 | `src/overlays/o099/overlay99BuildHeightGrid.c` | `overlay99BuildHeightGrid` | `o099` | `size-mismatch` | 456 | 104 | 104 | 44 | 44 | 4 | — |
| 273 | `src/main/font.c` | `func_8004C690` | `main` | `size-mismatch` | 584 | 105 | 105 | 0 | 0 | -8 | — |
| 274 | `src/main/track.c` | `func_8000D3B8` | `main` | `size-mismatch` | 440 | 105 | 105 | 4 | 4 | -4 | — |
| 275 | `src/overlays/o068/overlay68RebuildSecondaryEntry.c` | `overlay68RebuildSecondaryEntry` | `o068` | `size-mismatch` | 488 | 105 | 105 | 0 | 0 | -8 | — |
| 276 | `src/main/weather_tail.c` | `func_8003C80C` | `main` | `size-mismatch` | 472 | 106 | 106 | 16 | 16 | -4 | — |
| 277 | `src/main/sched.c` | `func_80030610` | `main` | `size-mismatch` | 768 | 113 | 112 | 0 | 0 | 4 | — |
| 278 | `src/main/frontend_37680.c` | `func_80036AB0` | `main` | `size-mismatch` | 432 | 113 | 113 | 0 | 0 | 28 | — |
| 279 | `src/main/track.c` | `func_8000D1B8` | `main` | `size-mismatch` | 512 | 114 | 114 | 48 | 48 | 8 | — |
| 280 | `src/main/objects.c` | `func_80008128` | `main` | `size-mismatch` | 500 | 116 | 116 | 0 | 0 | 20 | — |
| 281 | `src/main/runlink.c` | `runlinkFreeCode` | `main` | `size-mismatch` | 736 | 117 | 117 | 0 | 0 | -4 | — |
| 282 | `src/main/matrix.c` | `func_8002AC84` | `main` | `size-mismatch` | 396 | 118 | 118 | 0 | 0 | 80 | — |
| 283 | `src/main/textures_35024.c` | `func_80034448` | `main` | `size-mismatch` | 856 | 118 | 118 | 88 | 88 | 4 | — |
| 284 | `src/overlays/o041/overlay41ProcessEntry.c` | `func_overlay_041_F0001464_188879C` | `o041` | `size-mismatch` | 492 | 120 | 120 | 16 | 16 | 20 | — |
| 285 | `src/overlays/o001/overlay_001_tail.c` | `overlay1AdvancePath` | `o001` | `size-mismatch` | 648 | 121 | 121 | 16 | 16 | 4 | — |
| 286 | `src/main/fx.c` | `wakeDraw` | `main` | `size-mismatch` | 708 | 122 | 122 | 0 | 0 | -4 | — |
| 287 | `src/main/track.c` | `func_800103D4` | `main` | `size-mismatch` | 640 | 122 | 122 | 0 | 0 | -4 | — |
| 288 | `src/main/fx.c` | `fxScreenEffect` | `main` | `size-mismatch` | 588 | 123 | 123 | 8 | 8 | -28 | — |
| 289 | `src/overlays/o031/overlay31InitializeParticleAssets.c` | `func_overlay_031_F00002E8_187F808` | `o031` | `size-mismatch` | 528 | 123 | 123 | 16 | 16 | 4 | — |
| 290 | `src/main/runlink.c` | `ProcessRelocationEntry` | `main` | `size-mismatch` | 584 | 126 | 126 | 0 | 0 | 4 | — |
| 291 | `src/overlays/o054/overlay54Initialize.c` | `func_overlay_054_F0000000_189ECA0` | `o054` | `size-mismatch` | 972 | 144 | 127 | 84 | 240 | 4 | — |
| 292 | `src/overlays/o034/overlay34SortAndDraw.c` | `overlay34SortAndDraw` | `o034` | `size-mismatch` | 760 | 129 | 128 | 20 | 20 | -4 | — |
| 293 | `src/main/objects.c` | `func_80007E40` | `main` | `size-mismatch` | 488 | 131 | 131 | 0 | 0 | 36 | — |
| 294 | `src/main/spranim.c` | `func_8001B798` | `main` | `size-mismatch` | 700 | 131 | 131 | 0 | 0 | -16 | — |
| 295 | `src/main/objects.c` | `func_80006C4C` | `main` | `size-mismatch` | 596 | 132 | 132 | 0 | 0 | -12 | — |
| 296 | `src/overlays/o044/overlay44UpdateFrameCache.c` | `overlay44UpdateFrameCache` | `o044` | `size-mismatch` | 748 | 133 | 133 | 0 | 0 | -4 | — |
| 297 | `src/main/matrix.c` | `func_8002AE10` | `main` | `size-mismatch` | 348 | 138 | 138 | 0 | 0 | 208 | — |
| 298 | `src/overlays/o037/overlay37Render.c` | `overlay37RenderEffect` | `o037` | `size-mismatch` | 856 | 139 | 139 | 0 | 0 | -4 | — |
| 299 | `src/main/weather.c` | `snow_render` | `main` | `size-mismatch` | 568 | 142 | 142 | 0 | 0 | 16 | — |
| 300 | `src/main/models.c` | `func_80020B10` | `main` | `size-mismatch` | 636 | 143 | 143 | 0 | 0 | -4 | — |
| 301 | `src/main/objects.c` | `func_8000486C` | `main` | `size-mismatch` | 664 | 146 | 146 | 0 | 0 | 8 | — |
| 302 | `src/main/track.c` | `func_8000DB34` | `main` | `size-mismatch` | 688 | 146 | 146 | 56 | 56 | -8 | — |
| 303 | `src/overlays/o010/overlay10Initialize.c` | `overlay10Initialize` | `o010` | `size-mismatch` | 688 | 147 | 147 | 0 | 0 | 156 | — |
| 304 | `src/main/frontend_37D50.c` | `func_800371BC` | `main` | `size-mismatch` | 600 | 148 | 148 | 44 | 44 | 36 | — |
| 305 | `src/main/objects.c` | `func_80009F74` | `main` | `size-mismatch` | 720 | 149 | 149 | 0 | 0 | -8 | — |
| 306 | `src/main/audiomgr.c` | `func_80001740` | `main` | `size-mismatch` | 836 | 154 | 153 | 0 | 0 | -24 | — |
| 307 | `src/main/fx.c` | `func_80049B14` | `main` | `size-mismatch` | 824 | 154 | 154 | 8 | 8 | 4 | — |
| 308 | `src/main/track.c` | `func_80012658` | `main` | `size-mismatch` | 708 | 154 | 154 | 0 | 0 | -8 | — |
| 309 | `src/main/lights.c` | `func_80019AB8` | `main` | `size-mismatch` | 736 | 155 | 155 | 32 | 32 | -4 | — |
| 310 | `src/overlays/o008/overlay_008.c` | `func_overlay_008_F0001000_185ED58` | `o008` | `size-mismatch` | 660 | 159 | 159 | 8 | 8 | -4 | — |
| 311 | `src/overlays/o001/overlay_001_tail.c` | `overlay1TransitionState` | `o001` | `size-mismatch` | 948 | 160 | 160 | 32 | 32 | -4 | — |
| 312 | `src/main/track.c` | `func_80010654` | `main` | `size-mismatch` | 684 | 162 | 162 | 0 | 0 | 4 | — |
| 313 | `src/overlays/o013/overlay13DrawActive.c` | `overlay13DrawActive` | `o013` | `size-mismatch` | 664 | 163 | 162 | 0 | 0 | -4 | — |
| 314 | `src/overlays/o101/overlay101BuildPresentationB.c` | `overlay101BuildPresentationB` | `o101` | `size-mismatch` | 832 | 163 | 162 | 16 | 16 | 4 | — |
| 315 | `src/overlays/o101/overlay101BuildPresentationC.c` | `overlay101BuildPresentationC` | `o101` | `size-mismatch` | 832 | 166 | 165 | 36 | 36 | 4 | — |
| 316 | `src/overlays/o101/overlay101BuildPresentationA.c` | `overlay101BuildPresentationA` | `o101` | `size-mismatch` | 832 | 167 | 166 | 16 | 16 | 4 | — |
| 317 | `src/main/fx.c` | `func_800479D4` | `main` | `size-mismatch` | 772 | 167 | 167 | 0 | 0 | -20 | — |
| 318 | `src/main/textures_354C8.c` | `func_80036544` | `main` | `size-mismatch` | 608 | 172 | 172 | 0 | 0 | 80 | — |
| 319 | `src/main/fx.c` | `func_80047304` | `main` | `size-mismatch` | 740 | 175 | 175 | 4 | 4 | -8 | — |
| 320 | `src/main/charControl.c` | `func_8001D960` | `main` | `size-mismatch` | 880 | 176 | 176 | 0 | 0 | 4 | — |
| 321 | `src/main/textures_354C8.c` | `func_800355A0` | `main` | `size-mismatch` | 1,076 | 177 | 177 | 0 | 0 | -4 | — |
| 322 | `src/overlays/o020/func_overlay_020_F0001148_1877720.c` | `func_overlay_020_F0001148_1877720` | `o020` | `size-mismatch` | 828 | 180 | 178 | 32 | 32 | -8 | — |
| 323 | `src/overlays/o066/func_overlay_066_F00004E0_18C6948.c` | `func_overlay_066_F00004E0_18C6948` | `o066` | `size-mismatch` | 816 | 181 | 181 | 0 | 0 | -12 | — |
| 324 | `src/overlays/o001/func_overlay_001_F0003258_184F638.c` | `func_overlay_001_F0003258_184F638` | `o001` | `size-mismatch` | 800 | 183 | 182 | 0 | 0 | -48 | — |
| 325 | `src/main/track.c` | `func_8000E5EC` | `main` | `size-mismatch` | 820 | 185 | 185 | 0 | 0 | 16 | — |
| 326 | `src/overlays/o020/overlay20UpdateGrid.c` | `overlay20UpdateGrid` | `o020` | `size-mismatch` | 860 | 185 | 185 | 0 | 0 | 4 | — |
| 327 | `src/overlays/o014/func_overlay_014_F0001830_1871108.c` | `func_overlay_014_F0001830_1871108` | `o014` | `size-mismatch` | 804 | 186 | 186 | 0 | 0 | 4 | — |
| 328 | `src/overlays/o011/func_overlay_011_F0001E4C_186A694.c` | `func_overlay_011_F0001E4C_186A694` | `o011` | `size-mismatch` | 1,180 | 189 | 186 | 216 | 216 | -4 | — |
| 329 | `src/main/track.c` | `func_80012234` | `main` | `size-mismatch` | 832 | 187 | 187 | 12 | 12 | 12 | — |
| 330 | `src/overlays/o087/func_overlay_087_F0000128_18D3090.c` | `func_overlay_087_F0000128_18D3090` | `o087` | `size-mismatch` | 1,896 | 195 | 193 | 44 | 44 | -16 | — |
| 331 | `src/main/objects.c` | `func_80006534` | `main` | `size-mismatch` | 820 | 198 | 198 | 0 | 0 | 8 | — |
| 332 | `src/overlays/o099/overlay99ApplySegment.c` | `overlay99ApplySegment` | `o099` | `size-mismatch` | 920 | 203 | 202 | 0 | 0 | -4 | — |
| 333 | `src/main/anim.c` | `func_800573C8` | `main` | `size-mismatch` | 932 | 203 | 203 | 44 | 44 | -8 | — |
| 334 | `src/main/main.c` | `func_80026FB4` | `main` | `size-mismatch` | 1,652 | 207 | 207 | 56 | 56 | 24 | — |
| 335 | `src/main/track.c` | `func_80011980` | `main` | `size-mismatch` | 860 | 211 | 211 | 0 | 0 | 8 | — |
| 336 | `src/main/anim.c` | `func_80056DD8` | `main` | `size-mismatch` | 916 | 214 | 214 | 0 | 0 | -12 | — |
| 337 | `src/main/fx.c` | `fxSPDPRipple` | `main` | `size-mismatch` | 928 | 224 | 224 | 8 | 8 | 8 | — |
| 338 | `src/main/lights.c` | `func_8001953C` | `main` | `size-mismatch` | 1,016 | 225 | 225 | 0 | 0 | 32 | — |
| 339 | `src/main/objects.c` | `func_80004C28` | `main` | `size-mismatch` | 952 | 230 | 230 | 0 | 0 | 4 | — |
| 340 | `src/main/charControl.c` | `func_8001EC44` | `main` | `size-mismatch` | 952 | 231 | 231 | 0 | 0 | 12 | — |
| 341 | `src/main/track.c` | `func_800115E4` | `main` | `size-mismatch` | 924 | 231 | 231 | 0 | 0 | 20 | — |
| 342 | `src/overlays/o020/func_overlay_020_F000038C_1876964.c` | `func_overlay_020_F000038C_1876964` | `o020` | `size-mismatch` | 1,080 | 256 | 256 | 0 | 0 | -24 | — |
| 343 | `src/main/camera.c` | `func_80023598` | `main` | `size-mismatch` | 1,136 | 263 | 263 | 0 | 0 | 8 | — |
| 344 | `src/overlays/o057/func_overlay_057_F00060F8_18A9CF0.c` | `func_overlay_057_F00060F8_18A9CF0` | `o057` | `size-mismatch` | 1,764 | 278 | 263 | 0 | 0 | -16 | — |
| 345 | `src/main/textures_354C8.c` | `func_800349A4` | `main` | `size-mismatch` | 1,088 | 265 | 265 | 8 | 8 | 8 | — |
| 346 | `src/overlays/o101/overlay101TailA6BC.c` | `overlay101TailA6BC` | `o101` | `size-mismatch` | 1,168 | 267 | 267 | 0 | 0 | 4 | — |
| 347 | `src/main/objects.c` | `func_80009AA8` | `main` | `size-mismatch` | 976 | 268 | 268 | 0 | 0 | 100 | — |
| 348 | `src/main/shadows.c` | `func_80017BCC` | `main` | `size-mismatch` | 1,256 | 271 | 271 | 0 | 0 | -4 | — |
| 349 | `src/main/rcpFast3d.c` | `func_8002FB34` | `main` | `size-mismatch` | 1,436 | 272 | 272 | 64 | 64 | -20 | — |
| 350 | `src/main/objects.c` | `func_8000784C` | `main` | `size-mismatch` | 1,052 | 273 | 273 | 0 | 0 | 56 | — |
| 351 | `src/overlays/o101/func_overlay_101_F0002510_18DDD30.c` | `func_overlay_101_F0002510_18DDD30` | `o101` | `size-mismatch` | 1,172 | 276 | 276 | 0 | 0 | -52 | — |
| 352 | `src/main/rcpFast3d.c` | `func_8002F618` | `main` | `size-mismatch` | 1,308 | 279 | 279 | 52 | 52 | 4 | — |
| 353 | `src/main/particles.c` | `func_80041530` | `main` | `size-mismatch` | 1,824 | 280 | 280 | 0 | 0 | 4 | — |
| 354 | `src/overlays/o035/func_overlay_035_F00001E0_1881EC0.c` | `func_overlay_035_F00001E0_1881EC0` | `o035` | `size-mismatch` | 1,424 | 283 | 283 | 120 | 120 | -12 | — |
