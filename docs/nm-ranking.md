...
The snapshot contains **434 queued identities**: **434 resolved measurements** and **0 unresolved identities**. Resolved target size totals **503,544 bytes (491.7 KiB)**.

Resolved rows span **72 overlays** and **2 resident TU groups** (`libultra`, `main`).

A supplementary objdiff report was not supplied; `objdiff_match_pct` covers **0 / 434** resolved rows.

Persisted configured-TU input evidence covers **434 / 434** resolved rows. Rows without it are retained legacy or bounded-refresh measurements and must be treated as requiring reproof.

Relocation-masked mismatch evidence covers **434 / 434** resolved rows. The raw count preserves literal object differences; the masked count removes only known linker-owned fields to expose the remaining code-generation mismatch. Neither replaces linked byte-identity proof.
...
| 218 | `src/overlays/o101/func_overlay_101_F00069E8_18E2208.c` | `func_overlay_101_F00069E8_18E2208` | `o101` | `other` | 3,852 | 617 | 614 | 136 | 136 | 0 | — |
| 219 | `src/overlays/o008/overlay_008.c` | `func_overlay_008_F0001294_185EFEC` | `o008` | `other` | 5,036 | 654 | 636 | 0 | 0 | 0 | — |
| 220 | `src/main/track.c` | `func_80010B4C` | `main` | `other` | 2,712 | 668 | 668 | 0 | 0 | 0 | — |
| 221 | `src/overlays/o050/func_overlay_050_F0000334_1896CA4.c` | `func_overlay_050_F0000334_1896CA4` | `o050` | `other` | 6,300 | 1,422 | 1,422 | 0 | 0 | 0 | — |
...
| 431 | `src/overlays/o052/overlay52TailB.c` | `func_overlay_052_F000063C_189ACAC` | `o052` | `size-mismatch` | 6,748 | 1,598 | 1,595 | 304 | 304 | -12 | — |
| 432 | `src/main/anim.c` | `func_800517E0` | `main` | `size-mismatch` | 7,232 | 1,786 | 1,785 | 0 | 0 | -344 | — |
| 433 | `src/overlays/o060/overlay60Prefix.c` | `func_overlay_060_F0000334_18BA10C` | `o060` | `size-mismatch` | 11,156 | 2,519 | 2,511 | 4 | 4 | -12 | — |
| 434 | `src/overlays/o058/func_overlay_058_F000138C_18B0574.c` | `func_overlay_058_F000138C_18B0574` | `o058` | `size-mismatch` | 14,456 | 3,696 | 3,693 | 0 | 0 | 532 | — |
