...
| `func_overlay_041_F0000000_1887338` | `src/overlays/o041/overlay41AdvanceStepRecords.c` | none | — | Retained configured candidate is 47/73 words with 26 register-only sites from `+0x54`, frame `0x30`, and three runtime-backed records (`D_800D6B58` HI/LO and resident call `func_8000D16C`); temp-FIFO, flag, source, and permuter routes are exhausted. One unchanged full-TU reproof, then park pending a new allocator mechanism. |
