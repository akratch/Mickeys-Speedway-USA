...
| `func_overlay_020_F0000204_18767DC` | `src/overlays/o020/overlay20UpdateObjectResource.c` | none | — | Retained full-TU and isolated C agree at 90/98 words, frame `0x70`, with eight register sites at `+0xB0/+0xB4/+0xC0/+0xC8/+0x108/+0x10C/+0x110/+0x114`. Four exact runtime calls resolve to `trackGetTrack`, `func_8000FEEC`, local `overlay20ConfigureResource`, and `sqrtf`; fallback object names are placeholders. Trace/source/flag/permuter routes are exhausted; one unchanged V0, then park. |
