...
| `func_overlay_005_F000031C_185B744` | `src/overlays/o005/overlay_005.c` | none | — | Retained configured full-TU C is 211/233 words, frame `0x98`, first `+0x9C`, with all 71 runtime relocation sites aligned. The 22 sites are the Span1-size carrier, one initialization-order swap, and three shifted stack-home groups. Runtime identity distinguishes ORT 1559/1561 behind `gOverlay5SoundState` and ORT 1565/1568 behind `gOverlay5ScaleValue`. Reproduce V0, then initialization order, Span1 carrier, and trace-directed declaration order only; cap six builds and resolve aliases before promotion. |
