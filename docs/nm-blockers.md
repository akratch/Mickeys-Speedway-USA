...
| `func_overlay_097_F0000508_18D83A0` | `src/overlays/o097/overlay97InitScale.c` | none | — | Fully configured direct candidate and linked C trial are one address-carrier word away at `+0xD0`; the former object-exact note was a fallback self-comparison and the three-word ranking omitted `-Wab,-r4300_mul`. Reproof-only V0 remains. |
