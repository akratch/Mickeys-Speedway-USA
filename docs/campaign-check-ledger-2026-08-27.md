...
`overlay43SubmitChildren` is a four-word ranking but lacks an attempt packet;
route it through the ordinary workbench/flag checks before expert escalation.
