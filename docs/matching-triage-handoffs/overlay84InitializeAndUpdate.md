...
- score: 12 differing positional words, improved from 71; 167/179 words exact
- frame: exact `0x58`
- relocations: five call sites align by offset and type, but all five static identities still differ; preflight fails closed on unresolved candidate identities
- first mismatch: `+0x14`
