...
- Remaining: W (nine rows, a2 for t0) and the two slot-address rows. On
  the 11 body W's identity reads the same: its 185 step fails by one
  (left 11, numintf 23) with v1 taken by w40 between the 5E9C piece's
  split (idx 127, 3.60) and W's (idx 178, 2.26).
