...
per-address row histogram are the two readings this pass turned on and neither
is in the tree yet: both are a re-run of `align_symbol._banded_edit_script`
...
function. It is worth promoting.
