...
- frame: exact `0x88`
- relocations: target and candidate each emit eight records, with 8/8 offsets and types aligned; all eight candidate identities remain unresolved, so preflight fails closed
- first mismatch: `+0xC`
