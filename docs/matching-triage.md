...
| `func_8002BB40` | memory | **P** | retained true `NON_MATCHING` full-TU and isolated C agree at 42/72 words with 30 register-only differences from `+0x8C` and all eight tuples exact; the apparent 72/72 ordinary object is `GLOBAL_ASM` | bounded dead-argument carrier ladder, eight-build cap |
