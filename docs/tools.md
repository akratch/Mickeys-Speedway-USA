...
| `tools/lane_status.py` | Read committed `lane/*` refs without opening sibling worktrees; reports unintegrated commits and advisory match claims for assignment de-duplication (ADR 0011). | [`docs/CONTRIBUTING.md`](CONTRIBUTING.md) `## Lane helpers` |
