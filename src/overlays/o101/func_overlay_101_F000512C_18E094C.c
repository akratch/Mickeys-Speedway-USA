 ...
 * relocations: 49
 * first-mismatch: +0x2C
 * summary: 298 masked/raw differences; 31 relocation sites and 4 identities align, with 39 candidate identities unresolved. Repeated-node allocation remains divergent.
