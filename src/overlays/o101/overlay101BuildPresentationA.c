 ...
 * relocations: 52
 * first-mismatch: +0x10
 * summary: 145 masked words from 161 at a size delta of +4, frame 0x20 and its ladder exact. L59 group fold plus the node-24 text store before the counter bump.
