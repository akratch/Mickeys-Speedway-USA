...
#define ADD_TEXT_ROW(field, rowY)                                            \
    ...
    ADD_TEXT_ROW(D_INPUT.textFC, 0x92);
    ADD_TEXT_ROW(D_INPUT.text100, 0x9C);
    ADD_TEXT_ROW(D_INPUT.text104, 0xA6);
