 ...
 * relocations: 1253
 * first-mismatch: +0x50
 * summary: 187 retained: late coordinate roles, restore-exit distribution and nested-sum identity fail to preserve reuse across both splits; three-family stall.
