 ...
 * accumulations is the sole statement-order change from the retained 47/73
 * baseline and is semantics-preserving for the distinct nonvolatile fields.
 * No attributable C object from this replay survives, so the guard and
 ...
 * linked module, and full-bin equality. Pinned exact-overlay scans found no
 * exact DKR/JFG donor. */
#ifdef NON_MATCHING
